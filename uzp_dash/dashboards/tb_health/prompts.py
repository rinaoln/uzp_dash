...
def _outflow_facts(a, al, unit: str) -> str:
    ...
    def _what(r):
        ...
        if r.get("promise_broken"):
            ...
            return f"обещали вернуть {qty}{when} — не вернулись"
        if r["tasks"]:
            return "отработали, возврата нет"
        return "месяц ухода вне окна задач"
...
def section_narratives(ctx, a) -> dict:
    ...
    prompt = (
        ...
        "сотрудников. Клиентов, по которым отработка не подтверждена, ставь первыми.\n\n"
