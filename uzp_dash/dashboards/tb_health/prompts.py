...
def section_narratives(ctx, a) -> dict:
    ...
    ctx_txt = (
        ...
        f"Управление портфелем (два НЕЗАВИСИМЫХ факта, они НЕ складываются в прогноз): "
        ...
        f"ПРО ПАЙПЛАЙН (ожидаемый приход по сделкам) НЕ ПИШИ ВООБЩЕ: из отчёта он "
        f"убран, и читатель этих чисел не увидит.\n"
        ...
        f"витрина, и список организаций показывает, чем его можно улучшить: "
        f"потенциал и возврат в прогнозе не учтены.\n"
    ...
    prompt = (
        ...
        "— «отработка», «потенциал», «портфель», «возврат», «привлечение» — "
        "используй как есть, это принятые термины.\n\n"
